...
CREATE TABLE showtimes (
    ...
    original_duration_micros BIGINT NOT NULL CHECK (original_duration_micros > 0),
...
CREATE TABLE bookings (
    ...
    late_discount_amount DECIMAL(18,2) NOT NULL DEFAULT 0 CHECK (late_discount_amount >= 0),
